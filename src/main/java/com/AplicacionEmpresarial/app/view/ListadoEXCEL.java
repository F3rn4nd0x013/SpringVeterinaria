package com.AplicacionEmpresarial.app.view;
...
public class ListadoEXCEL extends AbstractXlsxView {
	...
	private static final String[] header = { "Id", "Nombre", "Mascota", "Telefono", "Fecha" };
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		for (Cliente cliente : listadoClientes) {
			...
			row.createCell(2).setCellValue(cliente.getMascota());
